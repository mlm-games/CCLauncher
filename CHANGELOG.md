...
- chore(deps): bump koinBom from 4.2.1 to 4.2.2
- chore(deps): bump com.google.androidbrowserhelper:androidbrowserhelper
- chore(deps): bump androidx.lifecycle:lifecycle-viewmodel-ktx
- chore(deps): bump lifecycleViewmodelCompose from 2.10.0 to 2.11.0
- chore(deps): bump androidx.compose:compose-bom
- chore(deps): bump navigation3Runtime from 1.1.2 to 1.1.3
- chore(deps): bump androidx.compose.foundation:foundation
- chore(deps): bump io.insert-koin.compiler.plugin from 1.0.0 to 1.0.1
...
- chore(deps): bump com.google.androidbrowserhelper:androidbrowserhelper
- chore(deps): bump androidx.compose:compose-bom
- chore(deps): bump navigation3Runtime from 1.1.1 to 1.1.2
- chore(deps): bump androidx.compose.foundation:foundation
...
- chore(deps): bump com.google.devtools.ksp from 2.3.6 to 2.3.7
- chore(deps): bump navigation3Runtime from 1.1.0 to 1.1.1
- chore(deps): bump androidx.compose.foundation:foundation
- chore(deps): bump androidx.compose:compose-bom
...
- chore(deps): bump koinBom from 4.2.0 to 4.2.1
- chore(deps): bump org.jetbrains.kotlinx:kotlinx-serialization-json
- Add back "Show App Icons" setting
- chore(deps): bump com.google.androidbrowserhelper:androidbrowserhelper
- chore(deps): bump navigation3Runtime from 1.0.1 to 1.1.0
...
- Bump androidx.compose:compose-bom from 2026.03.00 to 2026.03.01
- Bump androidx.compose.foundation:foundation from 1.10.5 to 1.10.6
...
- Bump org.jetbrains.kotlin:kotlin-stdlib from 2.3.10 to 2.3.20
- Bump org.jetbrains.kotlin:kotlin-reflect from 2.3.10 to 2.3.20
- Bump kmpSettingsCore from 0.6.1 to 0.6.3
- Bump kotlin from 2.3.10 to 2.3.20
- tap to open app drawer is false by dedault (fix #149)
- Bump androidx.compose.foundation:foundation from 1.10.4 to 1.10.5
- Bump androidx.datastore:datastore-preferences from 1.2.0 to 1.2.1
- Bump androidx.datastore:datastore-preferences-core from 1.2.0 to 1.2.1
- Bump androidx.compose:compose-bom from 2026.02.01 to 2026.03.00
...
- Bump androidx.compose:compose-bom from 2026.02.00 to 2026.02.01
